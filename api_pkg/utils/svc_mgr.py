class MicroService:
    def __init__(self, start_port: int, instances: int, prefix: str, host: str) -> None:
        '''
    ...
    def get_host(self) -> str:
        ''' Get the host for this microservice. '''
        return self.__host
...
class MicroServiceManager:
    def __init__(self, services_config):
        ...
        for svc_key in services_config:
            ...
            self.__services[svc_key] = MicroService(start_port, instances, prefix, host)
    ...
    def get_service_prefix(self, svc_key) -> str:
        return self.__services[svc_key].get_prefix()

    def get_service_host(self, svc_key) -> str:
        return self.__services[svc_key].get_host()